...
import (
	...
	"github.com/ageneralai/maven/kernel/channels/webhook"
	"github.com/ageneralai/maven/kernel/config"
	"log/slog"

	"github.com/ageneralai/maven/kernel/httpc"
...
func (w *WeComChannel) Capabilities() channels.CapabilitySet {
	return channels.CapabilitySet{FileUpload: true, ReactiveOnly: true}
}
