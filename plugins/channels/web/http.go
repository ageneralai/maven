...
import (
	...
	"github.com/ageneralai/maven/plugins/channels/web/responses"
	webvoice "github.com/ageneralai/maven/plugins/channels/web/voice"
	"github.com/ageneralai/maven/plugins/channels/web/wsession"
...
var (
	_ channels.Channel       = (*WebChannel)(nil)
	_ channels.StreamChannel = (*WebChannel)(nil)
)
