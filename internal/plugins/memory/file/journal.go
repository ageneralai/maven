...
type shadowRuntimeFactory func(cfg *config.Config, prompt string, tools []tool.Tool) (*sdkapi.Runtime, error)

func defaultShadowRuntime(cfg *config.Config, prompt string, tools []tool.Tool) (*sdkapi.Runtime, error) {
...
func runShadowTurn(ctx context.Context, rt *sdkapi.Runtime, log *slog.Logger, ev hook.PostTurnEvent) {
