...
func NewWhatsApp(cfg config.WhatsAppConfig, lg *slog.Logger, msgBus *bus.MessageBus) (*WhatsAppChannel, error) {
...
func (w *WhatsAppChannel) Capabilities() channels.CapabilitySet {
	return channels.CapabilitySet{FileUpload: true}
}
